...
void HariMain(void)
{
	...
	putfont8_asc(binfo->vram, binfo->scrnx, 31,  53, COL8_000000, "Hello YuWan, Hello CuMian.");
	putfont8_asc(binfo->vram, binfo->scrnx, 30,  52, COL8_FFFFFF, "Hello YuWan, Hello CuMian.");

	sprintf(s, "scrnx = %d", binfo->scrnx);
	putfont8_asc(binfo->vram, binfo->scrnx, 16, 94, COL8_FFFFFF, s);
